...
#include "RyuCharacterAbilityState.generated.h"

UCLASS()
class RYU_PROTOTYPE_API URyuCharacterAbilityState : public URyuCharacterOnGroundState
{
	GENERATED_BODY()
public:
	URyuCharacterAbilityState();
