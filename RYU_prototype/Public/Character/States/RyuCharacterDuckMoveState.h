...
#include "RyuCharacterDuckMoveState.generated.h"

UCLASS()
class RYU_PROTOTYPE_API URyuCharacterDuckMoveState : public URyuCharacterOnGroundState
{
	GENERATED_BODY()
public:
	URyuCharacterDuckMoveState();
