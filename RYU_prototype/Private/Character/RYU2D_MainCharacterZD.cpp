...
void ARYU2D_MainCharacterZD::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
    ...
    PlayerInputComponent->BindAction("Sneak", IE_Pressed, this,
                                     &ARYU2D_MainCharacterZD::SneakPressed);
    PlayerInputComponent->BindAction("Sneak", IE_Released, this,
                                     &ARYU2D_MainCharacterZD::SneakReleased);
}
...
void ARYU2D_MainCharacterZD::SetClimbingPostitionsAndMovementMode(EPlayerMovement PlayerMove,
...
UBoxComponent* ARYU2D_MainCharacterZD::GetOverlappedClimbingComponent(FName UpOrDown,
                                                                      FName LeftOrRight)
{
...
void ARYU2D_MainCharacterZD::HandleSphereColliderEndOverlap(
    UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp,
...
void ARYU2D_MainCharacterZD::SetCurrentTimelineParamsFloat(UCurveFloat* FloatCurveX,
...
void ARYU2D_MainCharacterZD::SetCurrentTimelineParamsVector(UCurveVector* VectorCurve,
                                                            bool TimelineIsLooping,
                                                            bool IgnoreTimeDilation)
{
    if (VectorCurve)
